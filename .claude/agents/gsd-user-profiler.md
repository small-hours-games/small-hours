...
<reference>
@/home/skogix/small-hours/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/skogix/small-hours/.claude/get-shit-done/references/user-profiling.md` to load:
