...
Reference full template: `/home/skogix/dev/small-hours/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/skogix/dev/small-hours/.claude/get-shit-done/templates/state.md`.
