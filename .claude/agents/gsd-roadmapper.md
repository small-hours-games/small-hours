...
Reference full template: `/home/dellvall/small-hours/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/dellvall/small-hours/.claude/get-shit-done/templates/state.md`.
