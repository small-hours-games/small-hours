...
- **Global scope**: `/home/dellvall/dot-claude/game/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/dellvall/dot-claude/game/.claude/notes/`)
...
2. Glob `/home/dellvall/dot-claude/game/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/dellvall/dot-claude/game/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/dellvall/dot-claude/game/.claude/notes/` — works in any directory
